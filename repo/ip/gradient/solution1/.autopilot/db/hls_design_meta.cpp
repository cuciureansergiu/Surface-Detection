...
const Port_Property HLS_Design_Meta::port_props[]={
	...
	Port_Property("input_f_Addr_A", 32, hls_out, 0, "bram", "MemPortADDR2", 1),
	Port_Property("input_f_EN_A", 1, hls_out, 0, "bram", "MemPortCE2", 1),
	Port_Property("input_f_WEN_A", 4, hls_out, 0, "bram", "MemPortWE2", 1),
	Port_Property("input_f_Din_A", 32, hls_out, 0, "bram", "MemPortDIN2", 1),
	Port_Property("input_f_Dout_A", 32, hls_in, 0, "bram", "MemPortDOUT2", 1),
	Port_Property("input_f_Clk_A", 1, hls_out, 0, "bram", "mem_clk", 1),
	Port_Property("input_f_Rst_A", 1, hls_out, 0, "bram", "mem_rst", 1),
	...
	Port_Property("output_f_Addr_A", 32, hls_out, 2, "bram", "MemPortADDR2", 1),
	Port_Property("output_f_EN_A", 1, hls_out, 2, "bram", "MemPortCE2", 1),
	Port_Property("output_f_WEN_A", 4, hls_out, 2, "bram", "MemPortWE2", 1),
	Port_Property("output_f_Din_A", 32, hls_out, 2, "bram", "MemPortDIN2", 1),
	Port_Property("output_f_Dout_A", 32, hls_in, 2, "bram", "MemPortDOUT2", 1),
	Port_Property("output_f_Clk_A", 1, hls_out, 2, "bram", "mem_clk", 1),
	Port_Property("output_f_Rst_A", 1, hls_out, 2, "bram", "mem_rst", 1),
...
const char* HLS_Design_Meta::dut_name = "gradient";
